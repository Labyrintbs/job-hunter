...
def main(argv: list[str] | None = None) -> int:
    ...
    p_rejudge_juniors = sub.add_parser("rejudge-juniors", help="one-off catch-up: rescreen/"
                                       "rejudge junior-titled postings screened or judged "
    ...
    if args.command == "rejudge-juniors":
